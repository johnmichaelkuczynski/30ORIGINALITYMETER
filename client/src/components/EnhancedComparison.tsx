                  ...
                  <CardContent className="space-y-3">
                    ...
                    <div className="w-full bg-gray-200 rounded-full h-2">
                      <div 
                        ...
                        style={{ width: `${result.comparisonVectors.contentSimilarity.lexicalOverlap * 10}%` }}
                      ></div>
                    </div>
                    ...
                    <Progress value={result.comparisonVectors.contentSimilarity.conceptualParaphraseOverlap * 10} />
