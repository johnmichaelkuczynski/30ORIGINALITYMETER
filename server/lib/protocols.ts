...
// EXACT INTELLIGENCE QUESTIONS (18 questions from updated user protocol)
...
// EXACT ORIGINALITY QUESTIONS (10 questions from updated user protocol)
export const ORIGINALITY_QUESTIONS = [
  ...
  "IF YOU GAVE A ROBOT THE DATASET TO WHICH THE PASSAGE IS A RESPONSE, WOULD THE ROBOT COME UP WITH THE SAME CONCLUSIONS? OR, ON THE CONTRARY, DOES IT BUTCHER IDEAS, THIS BEING WHAT GIVES IT A SHEEN OF 'ORIGINALITY'?",
...
// EXACT OVERALL QUALITY QUESTIONS (14 questions from updated user protocol)  
